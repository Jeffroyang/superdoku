...
private:
    ...
    ConstraintSolver(array<array<vector<int>, GRID_SIZE>, GRID_SIZE> other_board) : board(other_board) {}
    ...
    deque<pair<pair<int, int>, pair<int, int>>> get_arcs() {
    ...
    bool remove_inconsistent(pair<int, int> cell1, pair<int, int> cell2) {
    ...
    vector<array<array<vector<int>, GRID_SIZE>, GRID_SIZE>> guess_successors(pair<int, int> next_cell) {
